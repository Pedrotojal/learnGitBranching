exports.strings = {
  ...
  'git-error-origin-fetch-no-ff': {
    ...
    'pt_PT': 'O fetch não pode ser realizado pois o ramo de origem não está sincronizado com o ramo remoto',
  ...
  'git-error-origin-push-no-ff': {
    ...
    'pt_PT': 'O repositório remoto divergiu do repositório local, então para enviar as mudanças não pode ser feito um simples fast forward (e por isso o push foi rejeitado). Faz pull das novas mudanças do repositório remoto, incorpora-os neste ramo, e tente novamente. Podes fazê-lo com git pull ou git pull --rebase',
  ...
  'help-vague-level': {
    ...
    'pt_PT': 'Estás num nível, logo há vários tipos de ajuda. Seleciona "help level" para aprender mais sobre esta lição, "help general" para aprender a usar o Learn GitBranching, ou "objective" ver como resolver o nível.',
  ...
  'goal-only-master': {
    ...
    'pt_PT': '<span class="fwber">Nota:</span> Apenas o ramo master será verificado neste nível. Os outros ramos (dentro das caixas mais claras) são somente para referência. Como sempre, podes ocultar esta janela com "hide goal"',

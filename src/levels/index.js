...
var sequenceInfo = exports.sequenceInfo = {
  intro: {
    ...
    about: {
      ...
      'pt_PT': 'Uma breve introdução à maioria dos comandos do git',
  ...
  rampup: {
    ...
    about: {
      ...
      'pt_PT': 'A próxima porção de maravilhas do git. Faminto?',
  ...
  remote: {
    ...
    displayName: {
      ...
      'pt_PT': 'Push & Pull -- repositórios remotos no Git!',
    ...
    about: {
      ...
      'pt_PT': 'Hora de partilhar os teus 1\'s e 0\'s; programar agora é social!',
  ...
  remoteAdvanced: {
    ...
    displayName: {
      ...
      'pt_PT': 'Até à origin e mais além -- repositórios remotos avançados!',
    ...
    about: {
      ...
      'pt_PT': 'E tu achavas que ser um déspota esclarecido seria mais divertido...',
  ...
  move: {
    ...
    about: {
      ...
      'pt_PT': 'Modifica tranquilamente a árvore de código',
  ...
  mixed: {
    ...
    about: {
      ...
      'pt_PT': 'Várias técnicas, truques e dicas sobre Git',
  ...
  advanced: {
    ...
    about: {
      ...
      'pt_PT': 'Para os verdadeiros valentes!',
